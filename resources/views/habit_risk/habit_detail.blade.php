...
<div>
                ...
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    <div class="inner-bnr-sldr">
                        <div id="inner-banner" class="owl-carousel">
                            @foreach ($habit_banner_data as $banner_item)
                                <div class="offer-main">
                                    ...
                                    <div class="offer-content">
                                        <div class="offer-heading">
                                            ...
                                            <p>{{str_limit($packg_habit_descp[$banner_item['product_id']], 85)}}</p>
                                        </div>
    ...
    <section class="riskcontent">
        <div class="container">
            <div class="row">
                @foreach ($habit_package_data as $item)
                            ...
                            <div class="image-area">
                                ...
                                <div class="offer-content">
                                    <div class="offer-heading">
                                        ...
                                        <p>{{str_limit($packg_habit_descp[$item['product_id']], 85)}}</p>
                                    </div>
                                    @if (count($item['test_includes']) > 0)
                                        <div class="offers-content">
                                            ...
                                            <a href="/{{$city_name}}/{{$item['product_type']}}/{{$item['link_rewrite']}}" class="know-more" target="_blank">+ Know More</a>
                                            <!-- <div class="ruree">
                                                <del>{{$item['actual_price']}}/-</del> {{$item['healthian_price']}}/-
                                            </div> -->

                                            <div class="pricebar">
                                               <p class="slashedprice">
                                                    <del><span class="rupeesign">₹</span>{{$item['actual_price']}}</del>
                                                </p>
                                                <p class="healthiansprice"> 
                                                    <span class="rupeesign">₹</span> {{$item['healthian_price']}} </p>
                                            </div>
