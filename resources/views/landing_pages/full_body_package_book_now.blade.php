...
.promotext h5{font-size:18px; line-height:25px;margin: 25px 0 16px 0; font-weight:600;}
.promotext span{color:#00a0a8;}
.booknowfullbody{ text-align: center; list-style: none; padding:10px 0px; margin: 0; float: none;}
.booknowfullbody ul{margin:0px; padding:0px; list-style:none;}
.booknowfullbody ul li{ display:inline-block; vertical-align:top; margin-right:20px; }
.booknowfullbody ul li a{ min-width: 170px;  background: #f27d27; border: 1px solid #f27d27; color: #fff;
    height: 45px; line-height: 45px; padding: 0 34px;     border-radius: 50px; font-size:16px;}
     .who{ text-align:center; font-size:16px !important; padding:15px 0px 0px 0px;  }
.btn-danger{color:#fff;background-color: #f37d26;border-color: #f37d26;transition: .3s ease-in-out;}
.booknowfullbody ul li a:hover{background-color: #f37d26; background:#f37d26;}
.booknowfullbody ul li a:active{background-color: #f37d26; background:#f37d26;}
.booknowfullbody ul li a:focus{background-color: #f37d26; background:#f37d26;}
.btn-danger:active:focus{background-color: #f37d26; background:#f37d26;}
.fixedmobdata{ display:none; }
.promomob{ text-align:center; }
.promomob h5{font-size:18px; line-height:25px;margin: 25px 0 16px 0; font-weight:600;}
.promomob span{color:#00a0a8;}

@media only screen and (max-width: 520px) {
    .banner-section {padding:0;}
    .banner-section .banner{display:none;}
    .why-healthiansdsec .img-thumbdiv h5{ padding:15px 19px; }
    ...
    .webpara{font-size:17px !important; margin:0px;}
 .valpara{font-size:15px !important;margin-bottom:25px;}
 .booknowfullbody ul li{ margin-right:10px; }
    ...
    .promomob h5{font-size:18px; line-height:25px;margin:6px 0 4px 0; font-weight:600;}
    .promotext h5{margin:5px 0 12px 0px;}
    .who{ padding-bottom:30px; }
     .promotext{ display:none; }
    .booknowfullbody ul li a{min-width: 134px; }
    .Our-Offerings .ofr-blok p{font-size:13px; text-align: center; min-height:82px; padding: 10px 21px;}
    .fixedmobdata{position: fixed;background-color: #fff5ed; padding: 10px; margin-bottom:0px; display: block; -webkit-box-shadow: 0px -4px 5px -5px rgba(0,0,0,0.5);-moz-box-shadow: 0px -4px 5px -5px rgba(0,0,0,0.5);box-shadow: 0px -4px 5px -5px rgba(0,0,0,0.5); bottom: 0px; width: 100%; z-index: 999; border-radius:0px; min-height: 50px;bottom:0px;}
}
...
<div class="promomob">
                    <h5>Offer available only on online bookings.
                        <br><span>Use code "HEALTH20"</span></h5>


                       <div class="booknowfullbody">
                            <ul>
                                <li><a href="javaScript:void(0);" class="btn btn-danger" onClick="bookNowPackage();">Book Now</a></li>

                                <li><a href="javaScript:void(0);" class="btn btn-danger" data-toggle="modal" data-target="#basicModal" data-whatever="@number">Call Now</a></li>
    ...
    <div class="container brdr-btm">
       <div class="row">
            <div class="col-lg-6 col-sm-6 col-xs-12">
                ...
                <h2>Full Body Tests @ <strike style="color:#bbb7b7;font-size:24px;">₹1049</strike> ₹840</h2>
                 <h3 class="webpara">60 Parameters</h3>
                <p class="valpara">Thyroid, Lipid, Liver, Hemogram, Kidney, Blood Glucose Fasting</p>
            </div>
                ...
                <div class="promotext">
                    <h5>Offer available only on online bookings.
                       ...
                       <div class="booknowfullbody">
                            <ul>
                                <li>
                                    <a href="javaScript:void(0);" class="btn btn-danger" onClick="bookNowPackage();">Book Now</a>

                                </li>

                                <li>
                                    <a href="javaScript:void(0);" class="btn btn-danger" data-toggle="modal" data-target="#basicModal" data-whatever="@number">Call Now</a>
                                </li>
                         ...
                         <p class="text-center who">60-70% of the diseases are preventable with timely Health checkups - World Health Organisation (WHO) 
