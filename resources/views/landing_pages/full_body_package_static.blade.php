...
.webpara{font-size:22px !important; margin:0px;}
 ...
 .who{ text-align:center; font-size:16px !important;  }
@media only screen and (max-width: 621px) {
    .banner-section {padding:0;}
    .serch-div{ display:none; }
    .banner-section .banner{display:none;}
    .why-healthiansdsec .img-thumbdiv h5{ padding:15px 15px; }
 ...
 .valpara{font-size:16px !important;}
    ...
    .footerdn{ display:none !important; }
        ...
        <div class="row">
            <div class="col-lg-6 col-xs-12">
                <a href="#" data-toggle="modal" data-target="#basicModal" data-whatever="@counter">
                    <div class="input-group footerdn">
                ...
                <img alt="undr-line-img" src="/img/campaign/undr-line-img.png" class="hidden-lg footerdn">
            </div>
