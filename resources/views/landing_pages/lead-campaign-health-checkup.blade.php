...
<style>
/* Bangalore campaign */
.bangalore_page_header{ background:url(/img/campaign/bangalorebannerweb.jpg) no-repeat center top; background-size:cover; height:591px;position:relative; margin:3px 0px 0px 0px;}
.bangalore_page_header .midwrapper{ width:1221px; margin:0px auto;}
.bangalore_page_header .midwrapper .header_caption{font-family: 'Lato', sans-serif; text-align:center; color: #00a0a8; padding:35px 0px; display:inline-block; margin:140px 0px 0px 295px; width: 492px;}
.bangalore_page_header .midwrapper .header_caption h4{ font-family: 'Lato', sans-serif;font-size:44px; font-weight:700; margin:0px; text-align:center; letter-spacing:-0.1px; }
.bangalore_page_header .midwrapper .header_caption h3{font-family: 'Lato', sans-serif; margin:0px;font-size:44px;text-align:center; font-weight:700;}
.bangalore_page_header .midwrapper .header_caption .launch{ margin:30px auto; font-family: 'Lato', sans-serif;  border-top:2px solid #00a0a8; border-bottom:2px solid #00a0a8; color:#00a0a8; text-align:center; display:inline-block; padding:5px; font-size:26px; text-transform:uppercase;}
.bangalore_page_header .midwrapper .header_caption .launch span{font-weight:700; font-style:italic;}

.bangalore_page_header .midwrapper .formBlocks{ float:right; width:390px; margin:57px 0px 0px 0px;font-size:32px; color:#fff;}
.bangalore_page_header .midwrapper .formBlocks h1{font-size:26px; color:#fff;font-family: 'Lato', sans-serif; padding:8px 0px 15px 0px; margin:0px;}
.bangalore_page_header .midwrapper .formBlocks h1 span{font-size:32px; font-weight:700; color:#fff; }
.bangalore_page_header .midwrapper .formBlocks h1 span .fa-inr{ font-size:12px; font-weight:normal;}
.bangalore_page_header .midwrapper .formBlocks .formcontainer{ background:rgba(0,103,108,0.9);padding:15px 40px; border-radius:10px; }
.bangalore_page_header .midwrapper .formBlocks .formcontainer .mainFormBlock{ margin-right:0px;}
.bangalore_page_header .midwrapper .formBlocks .formcontainer .mainFormBlock ul{ margin:0px; padding:0px; list-style:none;}
.bangalore_page_header .midwrapper .formBlocks .formcontainer .mainFormBlock ul li{ display:block; padding:0px;}
.bangalore_page_header .midwrapper .formBlocks .formcontainer .mainFormBlock ul li .form-field{ margin:5px 10px 10px 0px;}
.bangalore_page_header .midwrapper .formBlocks .formcontainer .mainFormBlock ul li .form-field input{display: block; width: 100%; height:38px; font-size: 16px!important; padding:7px 12px 7px 12px;
color: #555; background-color: #fff;background-image: none;border: 1px solid #fff; border-radius:3px;font-family: 'Lato', sans-serif;}
.bangalore_page_header .midwrapper .formBlocks .formcontainer .mainFormBlock ul li .form-ctabtn{margin:15px 0 10px;}
.bangalore_page_header .midwrapper .formBlocks .formcontainer .mainFormBlock ul li .form-ctabtn .ctabutton{ box-shadow:-2px 3px 4px -1px rgba(0,0,0,.18); display:inline-block;  border: 1px solid #e1530d; display:inline-block; background:#e1530d; background-image: -ms-linear-gradient(top, #ff7632 0%, #e1530d 100%); background-image: -moz-linear-gradient(top, #ff7632 0%, #00888E 100%); background-image: -o-linear-gradient(top, #ff7632 0%, #e1530d 100%);background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, #e1530d), color-stop(100, #e1530d));background-image: -webkit-linear-gradient(top, #ff7632 0%, #e1530d 100%); background-image: linear-gradient(to bottom, #ff7632 0%, #e1530d 100%);color:#fff; font-size:18px; border-radius:20px; letter-spacing:0.4px;font-family: 'Lato', sans-serif; padding:9px 25px; font-weight:700; text-transform:uppercase;}
.bangalore_page_header .midwrapper .formBlocks .formcontainer .mainFormBlock ul li .form-ctabtn .ctabutton:hover{}
.form-select-opt{ width:100%; color:#757575;font-size: 16px!important; font-family:'Lato', sans-serif; border-radius:3px; padding:9px 12px 9px 7px; border:0;}
.form-select-opt option{ text-transform:capitalize;}
.enquirefor{ background:#fff; font-size:12px; text-transform:uppercase; color:#000;font-family:'Lato', sans-serif; font-weight:700; padding:5px 12px; display:inline; 
border-radius:25px;}
...
.healthcheck_productpanel .productThumb .testBrief .fastingTime{ font-size:13px;font-family: 'Lato', sans-serif; letter-spacing:-0.25px; color:#353535; margin:0px; padding:0px;}
...
.bangalore_page_header{max-width:100%; margin:2px auto 0px auto; height: 100%; background-size: 100%;}
.bangalore_page_header .midwrapper .header_caption{ text-align:right; color: #00a0a8; padding:28px 20px 0px 0px; display:block; margin:0px; max-width: 100%; width:100%;}
.bangalore_page_header .midwrapper{ width:100%;}
.bangalore_page_header .midwrapper .header_caption h4{ font-size:1.4em; text-align:right;}
.bangalore_page_header .midwrapper .header_caption h3{font-size:1.4em; text-align:right;}
.bangalore_page_header .midwrapper .header_caption .launch{ padding:2px 0px;font-size: 1.1em; margin:14px auto; border-top:1px solid #00a0a8; border-bottom:1px solid #00a0a8;}
.bangalore_page_header .midwrapper .formBlocks{ margin-top:8px; float:none; width:100%;}
.bangalore_page_header .midwrapper .formBlocks .formcontainer{ border-radius:0px; padding:0px 25px 15px 25px;}
.bangalore_page_header .midwrapper .formBlocks h1{font-size:21px !important; font-weight: normal !important; padding:10px 0px 10px 0px;}
.bangalore_page_header .midwrapper .formBlocks h1 span{ font-size:27px !important;}
.bangalore_page_header .midwrapper .formBlocks .formcontainer .mainFormBlock ul li .form-ctabtn .ctabutton{ width:100%; display:block;}
.bangalore_page_header .midwrapper .formBlocks .formcontainer .mainFormBlock ul li .form-field{ margin:5px 0 10px;}
.healthcheck_productpanel .productThumb .pricingsection .rightBook a{padding:10px 24px; font-size:18px;}
.healthcheck_productpanel .productThumb .testBrief .testInclude{ font-size:20px;}
.bangalore_page_header .midwrapper .formBlocks .formcontainer .mainFormBlock ul li{ padding:0px 9px 0px 0px;}
    ...
    <div class="fluid-container">
        ...
        <div class="topcall_us">
            <a class="call_us" href="">
                <p>Talk our Health Advisor</p>
                <span>080 33 99 99 33</span></a>
        </div>
    </div>
    <div class="clear"></div>
</div>

<header class="bangalore_page_header">
    <div class="midwrapper">
       <div class="header_caption">
          <h4>India's Largest Health Test</h4>
          <h3>@Home Service</h3>
          <div class="launch">Now in <span>Bengaluru</span></div>
       </div>
       <div class="formBlocks">
          <div class="formcontainer" id="getaQuote">
             <p class="enquirefor">enquire for</p>
             <h1 style="font-weight:700; font-size:36px;">
                Full Body Checkup <br>
                <span>Starting @ <span class="fontrupee">₹</span>999</span>
             </h1>
             <div class="clear"></div>
    ...
    <script type="text/javascript">       
        ...
        $(document).ready(function(){
            $("#city option").each(function(){
                if ($(this).text().toLowerCase() == "bengaluru") {
