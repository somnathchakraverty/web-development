 ...
 */
tagsInput.directive('tagsInput', ["$timeout", "$document", "$window", "$q", "tagsInputConfig", "tiUtil", "$rootScope", function($timeout, $document, $window, $q, tagsInputConfig, tiUtil, $rootScope) {
